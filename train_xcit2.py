...
from model import DINOHead, info_nce_logits, SupConLoss, DistillLoss, ContrastiveLearningViewGenerator, get_params_groups, CustomDINOHead, DINOHead2
...
def train(student, train_loader, test_loader, unlabelled_train_loader, args):
    ...
    met_loss_func = losses.ArcFaceLoss(args.mlp_out_dim, 512, margin=28.6, scale=64)
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            with torch.cuda.amp.autocast(fp16_scaler is not None):
                ...
                # cls_loss = met_loss_func(sup_logits, sup_labels)
                ...
                # loss = 0
                classfication_loss = (1 - args.sup_weight) * cluster_loss + args.sup_weight * cls_loss
                representation_loss = (1 - args.sup_weight) * contrastive_loss + args.sup_weight * sup_con_loss
                
                
                if args.rep_weight is not None:
                    loss =  (1 - args.rep_weight) * classfication_loss +  args.rep_weight * representation_loss
                else: 
                    loss =  classfication_loss + representation_loss
...
if __name__ == "__main__":
    ...
    if args.head_type == "custom":
        ...
        projector = DINOHead2(in_dim=args.feat_dim, out_dim=args.mlp_out_dim, nlayers=args.num_mlp_layers)
